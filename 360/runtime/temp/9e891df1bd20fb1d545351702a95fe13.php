<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:75:"D:\phpStudy\WWW\360\public_html/../application/member\view\shop\index.phtml";i:1505288073;s:71:"D:\phpStudy\WWW\360\public_html/../application/member\view\layout.phtml";i:1510577482;}*/ ?>
<?php
if(!request()->isAjax()){
?>
<!doctype html>
...
<textarea name="remark" id="editor_9045" class="form-control" style="height: 400px"></textarea>
<script>
$(function(){
    var editor_9045 = new wangEditor('editor_9045');
    editor_9045.create();
    editor_9045.onchange = function () {
