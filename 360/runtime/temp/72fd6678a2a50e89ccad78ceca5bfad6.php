<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:102:"/Applications/XAMPP/xamppfiles/htdocs/360/public_html/../application/member/view/member/password.phtml";i:1499832452;s:93:"/Applications/XAMPP/xamppfiles/htdocs/360/public_html/../application/member/view/layout.phtml";i:1505292852;}*/ ?>
<?php
if(!request()->isAjax()){
?>
<!doctype html>
...
<div class="container-fluid">
    ...
    <div class="panel-body">
        <form class="form-horizontal" method="post" action="<?php echo request()->url(); ?>" id="editForm">
