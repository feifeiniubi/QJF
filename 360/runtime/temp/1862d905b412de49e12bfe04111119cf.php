<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"D:\PHP\phpstudy\WWW\9503\360\public_html/../application/member\view\shop\index.phtml";i:1510656127;s:80:"D:\PHP\phpstudy\WWW\9503\360\public_html/../application/member\view\layout.phtml";i:1510656127;}*/ ?>
<?php
if(!request()->isAjax()){
?>
<!doctype html>
...
<textarea name="remark" id="editor_2217" class="form-control" style="height: 400px"></textarea>
<script>
$(function(){
    var editor_2217 = new wangEditor('editor_2217');
    editor_2217.create();
    editor_2217.onchange = function () {
