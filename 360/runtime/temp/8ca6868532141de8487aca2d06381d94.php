<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:100:"/Applications/XAMPP/xamppfiles/htdocs/360/public_html/../application/member/view/stock/storage.phtml";i:1499832452;s:93:"/Applications/XAMPP/xamppfiles/htdocs/360/public_html/../application/member/view/layout.phtml";i:1505647697;}*/ ?>
<?php
if(!request()->isAjax()){
?>
<!doctype html>
...
<div class="panel">
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-sm-4">
                <a class="btn btn-primary" href="<?php echo url('add_storage'); ?>"><i class="icon icon-plus"></i> 采购入库</a>
            </div>
            ...
            foreach ($list as $i=>$row) {
              ...
              $amount= \app\member\model\StockStorage::where('orderid',$row['orderid'])->sum('amount');
                ...
                <tr>
                    ...
                    <td>
                        <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-remote="<?php echo url('show_storage'); ?>?orderid=<?php echo $row['orderid']; ?>">采购清单</button>
                    </td>
                </tr>
                <?php
                }
