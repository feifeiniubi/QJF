<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:98:"/Applications/XAMPP/xamppfiles/htdocs/360/public_html/../application/member/view/member/role.phtml";i:1499832452;s:93:"/Applications/XAMPP/xamppfiles/htdocs/360/public_html/../application/member/view/layout.phtml";i:1505647697;}*/ ?>
<?php
if(!request()->isAjax()){
?>
<!doctype html>
...
<div class="panel">
    ...
    <div class="panel-body">
        <a href="<?php echo url('role_edit'); ?>" class="btn btn-primary">
        ...
        <table class="table table-hover table-striped">
            ...
            foreach ($list as $i=>$row) {
                ...
                <tr>
                    ...
                    <td class="text-danger"><?php echo $row['remark']; ?></td>
                    <td><?php echo $row['sort']; ?></td>
                    <td>
                        <a href="<?php echo url('role_edit'); ?>?id=<?php echo $row['id']; ?>" class="btn btn-mini btn-primary">修改</a>
                        <a href="<?php echo url('role_delete'); ?>?id=<?php echo $row['id']; ?>" class="btn btn-mini btn-primary tmdDelete">删除</a>
                    </td>
                </tr><?php
            }
            ?>
