<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:106:"/Applications/XAMPP/xamppfiles/htdocs/360/public_html/../application/member/view/customer/track_edit.phtml";i:1505288073;s:93:"/Applications/XAMPP/xamppfiles/htdocs/360/public_html/../application/member/view/layout.phtml";i:1505647697;}*/ ?>
<?php
if(!request()->isAjax()){
?>
<!doctype html>
...
<form class="form-horizontal" method="post" id="editForm" action="<?php echo request()->url(); ?>">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2">对接人：</label>
                        <div class="col-sm-4">
                            <input type="text" class="form-control" name="linkman" placeholder="">
                        </div>
                        <label class="col-sm-2">跟踪方式：</label>
                        <div class="col-sm-4">
                            <select name="type" class="mySelect form-control"><option value=""></option><option value="1">电话跟踪</option><option value="2">微信跟踪</option><option value="3">上门跟踪</option><option value="4">其他方式</option></select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea name="remark" rows="10" style="width:100%" class="form-control"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3">下次回访时间：</label>
                        <div class="col-sm-9">
