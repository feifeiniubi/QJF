<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:99:"/Applications/XAMPP/xamppfiles/htdocs/360/public_html/../application/member/view/member/index.phtml";i:1505700879;s:93:"/Applications/XAMPP/xamppfiles/htdocs/360/public_html/../application/member/view/layout.phtml";i:1505647697;}*/ ?>
<?php
if(!request()->isAjax()){
?>
<!doctype html>
...
<div class="panel">
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-sm-4">
                <a href="<?php echo url('edit'); ?>" class="btn btn-primary"><i class="icon icon-plus"></i> 新增</a>
            </div>
    ...
    <div class="table-responsive">
        <table class="table table-hover table-striped">
            ...
            foreach ($list as $i=>$row) {
                ...
                <tr>
                    <td><?php echo $i+1; ?></td>
                    <td><?php echo $row['realname']; ?>(<?php echo $row['username']; ?>)<?php if($row['openid']){echo " <i class='icon icon-wechat'></i>";}?></td>
                    <td><?php echo $row->Role->name; ?></td>
                    <td><?php echo \my::selectText('gender',$row['gender']) ?></td>
                    <td><img src="<?php echo $row['photo']; ?>" alt="" width="35" height="35"/></td>
                    <td><?php echo $row['lasttime']; ?></td>
                    <td>
                        <a href="<?php echo url('edit'); ?>?id=<?php echo $row['uid']; ?>" class="btn btn-sm btn-primary">修改</a>
                        <a href="<?php echo url('delete'); ?>?id=<?php echo $row['uid']; ?>" class="btn btn-sm btn-primary tmdDelete">删除</a>
                    </td>
                </tr>
                <?php
            }
