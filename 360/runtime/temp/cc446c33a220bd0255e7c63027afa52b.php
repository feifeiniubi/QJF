<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:102:"/Applications/XAMPP/xamppfiles/htdocs/360/public_html/../application/member/view/customer/search.phtml";i:1505288073;s:93:"/Applications/XAMPP/xamppfiles/htdocs/360/public_html/../application/member/view/layout.phtml";i:1505647697;}*/ ?>
<?php
if(!request()->isAjax()){
?>
<!doctype html>
...
<div class="panel">
    ...
    <div class="panel-body">
        <div class="row">
            ...
            <form class="form-horizontal" method="post" id="editForm" action="/member/customer/index/">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <div class="pure-g" data-toggle="distpicker">
                                <select class="form-control sm-3-5" name="province"
                                        data-province="<?= $editData['province'] ?: '' ?>">
                                </select>
                                <select class="form-control sm-3-5" name="city"
