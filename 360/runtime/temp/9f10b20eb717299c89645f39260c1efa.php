<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:97:"/Applications/XAMPP/xamppfiles/htdocs/360/public_html/../application/member/view/sales/show.phtml";i:1499832452;s:93:"/Applications/XAMPP/xamppfiles/htdocs/360/public_html/../application/member/view/layout.phtml";i:1505292852;}*/ ?>
<?php
if(!request()->isAjax()){
?>
<!doctype html>
    ...
    <div class="row">
        ...
        <table class="table table-hover table-striped">
            ...
            foreach ($list as $i=>$row) {
                ...
                <tr>
                    <td><?php echo $i+1; ?></td>
                    <?php $u= \app\member\model\StockProduct::where('id',$row['pid'])->find();?>
                    <td><?php echo $u['pname']; ?></td>
                    <td><?php echo $row['quantity']; ?></td>
                    <td><?php echo $row['price']; ?></td>
                    <td><?php echo $row['discount_rate']; ?></td>
                    <td><?php echo $row['discount_money']; ?></td>
                    <td><?php echo $row['money']; ?></td>
                    <td><?php echo $row['remark']; ?></td>
                    <td>
                        <?php if($row['status']=='0'){?>
                        <a class="btn btn-sm btn-primary" >正常状态</a>
                        <?php }else{?>
                        <a class="btn btn-sm btn-danger" >已经退单</a>
                        <?php }?>
                    </td>
                </tr>
                <?php
