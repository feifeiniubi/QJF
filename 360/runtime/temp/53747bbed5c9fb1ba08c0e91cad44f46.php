<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:76:"D:\phpStudy\WWW\360\public_html/../application/member\view\member\edit.phtml";i:1499832452;s:71:"D:\phpStudy\WWW\360\public_html/../application/member\view\layout.phtml";i:1509544388;}*/ ?>
<?php
if(!request()->isAjax()){
?>
<!doctype html>
...
<textarea name="remark" id="editor_6373" class="form-control" style="height: 400px"></textarea>
<script>
$(function(){
    var editor_6373 = new wangEditor('editor_6373');
    editor_6373.create();
    editor_6373.onchange = function () {
