<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:97:"/Applications/XAMPP/xamppfiles/htdocs/360/public_html/../application/member/view/sales/edit.phtml";i:1505288073;s:93:"/Applications/XAMPP/xamppfiles/htdocs/360/public_html/../application/member/view/layout.phtml";i:1505647697;}*/ ?>
<?php
if(!request()->isAjax()){
?>
<!doctype html>
                ...
                <form class="form-horizontal" action="<?php echo request()->url(); ?>" method="post" id="editForm">
                    ...
                    <table class="table  table-bordered parent">
                        ...
                        <?php foreach ($listdata as $r){ ?>
                            <tr class="row">
                                <td>
                                    <input type="hidden" class="" style="border:0px;" name="data_id[]"  value="<?php echo $r['id']; ?>">
                                ...
                                <td class="select-doc">
                                    <input type="hidden" class="text-center" style="border:0px;" name="data_pid[]" value="<?php echo $r['pid']; ?>">
                                    <input type="text" class="text-center" style="border:0px;" name="data_pname[]" value="<?php echo $p['pname']; ?>">
                                </td>
                                <td><input type="text" class="text-center" style="border:0px;" name="data_unit[]"> </td>
                                <td><input type="text" class="text-center quantity calcs_input_quantity" style="border:0px;" name="data_quantity[]" value="<?php echo $r['quantity']; ?>"> </td>
                                <td><input type="text" class="text-right price calcs_input_price" style="border:0px;" name="data_price[]" value="<?php echo $r['price']; ?>"> </td>
                                <td><input type="text" class="text-right calcs_input_discount_rate" style="border:0px;" name="data_discount_rate[]"  value="<?php echo $r['discount_rate']; ?>"> </td>
                                <td><input type="text" class="text-right discount_number calcs_input_discount" style="border:0px;" name="data_discount_money[]" value="<?php echo $r['discount_money']; ?>"> </td>
                                <td><input type="text" class="text-right sale_money calcs_input_money" style="border:0px;" name="data_money[]" value="<?php echo $r['money']; ?>"> </td>
                                <td><input type="text" class="" style="border:0px;" name="data_remark[]"  value="<?php echo $r['remark']; ?>"> </td>
                            </tr>
                            <?php } ?>
                        <tbody class="t-body">
...
<script>
    ...
    $(function () {
        ...
        $('.parent').on('click','.clone_remove', function () {
            ...
            var url = "<?php echo url('Sales/delete_ordersdata'); ?>";
            $.post(url, {id: id}, function (ret) {
                pageInit();
                calcs();
            }, "json");
