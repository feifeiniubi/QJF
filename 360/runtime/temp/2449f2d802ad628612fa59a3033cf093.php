<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:104:"/Applications/XAMPP/xamppfiles/htdocs/360/public_html/../application/member/view/sales/returnorder.phtml";i:1499997248;s:93:"/Applications/XAMPP/xamppfiles/htdocs/360/public_html/../application/member/view/layout.phtml";i:1505292852;}*/ ?>
<?php
if(!request()->isAjax()){
?>
<!doctype html>
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php $u= \app\member\model\Member::get($td['userid']);?><?php echo $u['realname']; ?></td>
                    <td><?php echo $td['datetime']; ?></td>
                    <td><?php echo $td['remark']; ?></td>
                    <td>
