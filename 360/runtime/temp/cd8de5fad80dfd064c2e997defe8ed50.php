<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:100:"/Applications/XAMPP/xamppfiles/htdocs/360/public_html/../application/member/view/finance/audit.phtml";i:1499914570;s:93:"/Applications/XAMPP/xamppfiles/htdocs/360/public_html/../application/member/view/layout.phtml";i:1505647697;}*/ ?>
<?php
if(!request()->isAjax()){
?>
<!doctype html>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <a class="btn btn-sm btn-primary tmdDelete" href="<?php echo url('audited'); ?>?id=<?php echo $row['id']; ?>"> 审核通过</a>
                        <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-remote="<?php echo url('return_order'); ?>?id=<?php echo $row['id']; ?>"> 退回订单</button>
                    </td>
                </tr>
            <?php } ?>
            </tbody>
