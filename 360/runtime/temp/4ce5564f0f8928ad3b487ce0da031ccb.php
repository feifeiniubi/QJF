<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:99:"/Applications/XAMPP/xamppfiles/htdocs/360/public_html/../application/member/view/stock/orders.phtml";i:1499998314;s:93:"/Applications/XAMPP/xamppfiles/htdocs/360/public_html/../application/member/view/layout.phtml";i:1505647697;}*/ ?>
<?php
if(!request()->isAjax()){
?>
<!doctype html>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-remote="<?php echo url('show'); ?>?id=<?php echo $row['id']; ?>"><i class="icon icon-columns"></i> 发货</button>
                    </td>
                </tr>
            <?php } ?>
            </tbody>
