<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:100:"/Applications/XAMPP/xamppfiles/htdocs/360/public_html/../application/member/view/stock/add_set.phtml";i:1505561575;s:93:"/Applications/XAMPP/xamppfiles/htdocs/360/public_html/../application/member/view/layout.phtml";i:1505292852;}*/ ?>
<?php
if(!request()->isAjax()){
?>
<!doctype html>
...
<form class="form-horizontal" method="post" id="editForm" action="<?php echo request()->url(); ?>">
     <?php if ($type == '1') { ?>
         <div class="form-group">
             <label class="col-sm-3">供应商名称：</label>
             <div class="col-sm-9">
         ...
         <div class="form-group">
             <label class="col-sm-3">联系地址：</label>
             <div class="col-sm-9">
     ...
     <?php } elseif ($type == '2') { ?>
         <div class="form-group">
             <label class="col-sm-3">上级分类：</label>
             <div class="col-sm-9">
                 <select name="pid" class="mySelect" style="width: 100%">
                     <option value="0">顶级</option>
                      <?= \app\member\model\StockSet::option() ?>
                 </select>
             </div>
         </div>
         <div class="form-group">
         ...
         <div class="form-group">
             ...
             <div class="col-sm-9">
                 <input type="text" class="form-control" name="listorder" placeholder="">
             </div>
         </div>
     <?php } ?>
    <div class="form-group">
