<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:102:"/Applications/XAMPP/xamppfiles/htdocs/360/public_html/../application/member/view/stock/inventory.phtml";i:1499832452;s:93:"/Applications/XAMPP/xamppfiles/htdocs/360/public_html/../application/member/view/layout.phtml";i:1505647697;}*/ ?>
<?php
if(!request()->isAjax()){
?>
<!doctype html>
...
<div class="panel">
    ...
    <div class="panel-body">
        <div class="row">
            <div class="col-sm-4">
                <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-remote="<?php echo url('add_inventory'); ?>"><i class="icon icon-plus"></i> 新建盘点</button>
            </div>
        ...
        <table class="table table-hover table-striped">
            ...
            foreach ($list as $i=>$row) {
                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-sm btn-primary" href="<?php echo url('show_inventory'); ?>?id=<?php echo $row['id']; ?>">盘点</a>
                        <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-remote="<?php echo url('show_storage'); ?>?id=<?php echo $row['id']; ?>">查看盘点报告</button>
                    </td>
                </tr>
                <?php
                }
